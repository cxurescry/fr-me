...
# Для демонстрации используем стандартное изображение из библиотеки matplotlib.
# В реальной работе замените путь на свой файл.
...
# В реальной работе замените эту часть на чтение из файла.
