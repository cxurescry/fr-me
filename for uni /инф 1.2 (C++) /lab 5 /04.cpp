...
int main() {
    ...
    unsigned int X_plus_1_unsigned = X_unsigned + 1;
    ...
    std::cout << "x + 1 =| " << std::setw(5) << X_plus_1_unsigned << " | " << std::setw(6) << std::oct << X_plus_1_unsigned << " | " << std::setw(4) << std::hex << X_plus_1_unsigned << " | " << toBinary(X_plus_1_unsigned) << std::endl;
